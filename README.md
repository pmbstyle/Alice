...
| Platform | Download |
|----------|----------|
| **Windows** | [Alice-AI-App-Windows-1.4.2-Setup.exe](https://github.com/pmbstyle/Alice/releases/download/v1.4.2/Alice-AI-App-Windows-1.4.2-Setup.exe) |
| **macOS** | [Alice-AI-App-Mac-1.4.2-Installer.dmg](https://github.com/pmbstyle/Alice/releases/download/v1.4.2/Alice-AI-App-Mac-1.4.2-Installer.dmg) |
| **Linux** | [Alice-AI-App-Linux-1.4.2.AppImage](https://github.com/pmbstyle/Alice/releases/download/v1.4.2/Alice-AI-App-Linux-1.4.2.AppImage) |
